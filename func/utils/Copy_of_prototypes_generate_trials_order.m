...
% trials_id_A = trials_id(1:200);
% trials_id_B = trials_id(201:400);
trials_id_A = trials_id(1:100);
trials_id_B = trials_id(101:200);
dots_id_A   = dot_id(1:100);
dots_id_B   = dot_id(101:200);

idx_A = randperm(length(trials_id_A));
idx_B = randperm(length(trials_id_B));

trials_id_A_rand = trials_id_A(idx_A);
trials_id_B_rand = trials_id_B(idx_B);
trials_id_rand = [trials_id_A_rand; trials_id_B_rand];

dots_id_A_rand = dots_id_A(idx_A);
dots_id_B_rand = dots_id_B(idx_B);
dots_id_rand = [dots_id_A_rand; dots_id_B_rand];
...
dot_id             = vertcat(zeros(size(xy_practice,1),1), dots_id_rand);
...
% create the table
% =========================================================================
trials_sequence = table(subj_id, age, gender, hand_preference, trials_id, blocks_id, breaks_id, dot_id, ActualDots_xy, RectHeight, RectWidth, ...
