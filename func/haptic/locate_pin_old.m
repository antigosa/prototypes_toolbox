...
% 4. Define "black" pixel criteria (adjust these thresholds as needed)
blue_threshold_lower = 0.1725; % Normalized range [0, 1]
blue_threshold_upper = 0.2;
red_threshold_upper_for_black = 0.1725;
green_threshold_upper_for_black = 0.1725;

is_black = (blueChannel >= blue_threshold_lower & blueChannel <= blue_threshold_upper) & ...
    (redChannel <= red_threshold_upper_for_black) & ...
    (greenChannel <= green_threshold_upper_for_black);
